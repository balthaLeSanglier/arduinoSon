...
struct mydsp : public dsp {
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("FreqHigh", &fHslider2, FAUSTFLOAT(1e+03f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(1e+04f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("QHigh", &fHslider3, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("mode", &fHslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("shift", &fHslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(-12.0f), FAUSTFLOAT(12.0f), FAUSTFLOAT(0.1f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = 0.05f * float(fSlow1 == 2.0f);
		float fSlow3 = fConst75 * std::max<float>(0.0f, float(fHslider2));
		float fSlow4 = std::cos(fSlow3);
		float fSlow5 = 2.0f * fSlow4;
		float fSlow6 = 0.5f * (std::sin(fSlow3) / std::max<float>(0.001f, float(fHslider3)));
		float fSlow7 = 1.0f - fSlow6;
		float fSlow8 = 1.0f / (fSlow6 + 1.0f);
		float fSlow9 = float(fSlow1 == 1.0f) * (1.0f - fSlow4);
		float fSlow10 = 0.5f * (fSlow4 + 1.0f);
		float fSlow11 = -1.0f - fSlow4;
		float fSlow12 = float(fSlow1 == 0.0f);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			fRec0[0] = std::fmod(fRec0[1] + 1001.0f - fSlow0, 1e+03f);
			float fTemp0 = std::min<float>(0.1f * fRec0[0], 1.0f);
			iRec3[0] = (iVec0[1] + iRec3[1]) % 10000;
			int iTemp1 = iRec3[0] < 1;
			iVec1[0] = iTemp1;
			iRec2[0] = (iRec2[1] + (iRec2[1] > 0)) * (iTemp1 <= iVec1[1]) + (iTemp1 > iVec1[1]);
			float fTemp2 = fConst4 * float(iRec2[0]);
			iRec6[0] = 1103515245 * iRec6[1] + 12345;
			fRec5[0] = 4.656613e-10f * float(iRec6[0]) - fConst16 * (fConst14 * fRec5[2] + fConst12 * fRec5[1]);
			fRec4[0] = fConst17 * (fRec5[2] + (fRec5[0] - 2.0f * fRec5[1])) - fConst9 * (fConst8 * fRec4[2] + fConst6 * fRec4[1]);
			float fTemp3 = fConst9 * (fRec4[2] + fRec4[0] + 2.0f * fRec4[1]) * std::max<float>(0.0f, std::min<float>(fTemp2, 2.0f - fTemp2));
			fRec1[0] = fTemp3 + fConst3 * fRec1[1] - fConst2 * fRec1[2];
			fRec7[0] = fTemp3 + fConst20 * fRec7[1] - fConst19 * fRec7[2];
			fRec8[0] = fTemp3 + fConst23 * fRec8[1] - fConst22 * fRec8[2];
			fRec9[0] = fTemp3 + fConst26 * fRec9[1] - fConst25 * fRec9[2];
			fRec10[0] = fTemp3 + fConst29 * fRec10[1] - fConst28 * fRec10[2];
			fRec11[0] = fTemp3 + fConst32 * fRec11[1] - fConst31 * fRec11[2];
			fRec12[0] = fTemp3 + fConst35 * fRec12[1] - fConst34 * fRec12[2];
			fRec13[0] = fTemp3 + fConst38 * fRec13[1] - fConst37 * fRec13[2];
			fRec14[0] = fTemp3 + fConst41 * fRec14[1] - fConst40 * fRec14[2];
			fRec15[0] = fTemp3 + fConst44 * fRec15[1] - fConst43 * fRec15[2];
			fRec16[0] = fTemp3 + fConst47 * fRec16[1] - fConst46 * fRec16[2];
			fRec17[0] = fTemp3 + fConst50 * fRec17[1] - fConst49 * fRec17[2];
			fRec18[0] = fTemp3 + fConst53 * fRec18[1] - fConst52 * fRec18[2];
			fRec19[0] = fTemp3 + fConst56 * fRec19[1] - fConst55 * fRec19[2];
			fRec20[0] = fTemp3 + fConst59 * fRec20[1] - fConst58 * fRec20[2];
			fRec21[0] = fTemp3 + fConst62 * fRec21[1] - fConst61 * fRec21[2];
			fRec22[0] = fTemp3 + fConst65 * fRec22[1] - fConst64 * fRec22[2];
			fRec23[0] = fTemp3 + fConst68 * fRec23[1] - fConst67 * fRec23[2];
			fRec24[0] = fTemp3 + fConst71 * fRec24[1] - fConst70 * fRec24[2];
			fRec25[0] = fTemp3 + fConst74 * fRec25[1] - fConst73 * fRec25[2];
			float fTemp4 = fRec1[0] + 0.25f * (fRec25[0] - fRec25[2]) + 0.11111111f * (fRec24[0] - fRec24[2]) + 0.0625f * (fRec23[0] - fRec23[2]) + 0.04f * (fRec22[0] - fRec22[2]) + 0.027777778f * (fRec21[0] - fRec21[2]) + 0.020408163f * (fRec20[0] - fRec20[2]) + 0.015625f * (fRec19[0] - fRec19[2]) + 0.012345679f * (fRec18[0] - fRec18[2]) + 0.01f * (fRec17[0] - fRec17[2]) + 0.008264462f * (fRec16[0] - fRec16[2]) + 0.0069444445f * (fRec15[0] - fRec15[2]) + 0.00591716f * (fRec14[0] - fRec14[2]) + 0.0051020407f * (fRec13[0] - fRec13[2]) + 0.0044444446f * (fRec12[0] - fRec12[2]) + 0.00390625f * (fRec11[0] - fRec11[2]) + 0.0034602077f * (fRec10[0] - fRec10[2]) + 0.0030864198f * (fRec9[0] - fRec9[2]) + 0.002770083f * (fRec8[0] - fRec8[2]) + 0.0025f * (fRec7[0] - fRec7[2]) - fRec1[2];
			fVec2[IOTA0 & 2047] = fTemp4;
			float fTemp5 = fRec0[0] + 1e+03f;
			int iTemp6 = int(fTemp5);
			float fTemp7 = std::floor(fTemp5);
			int iTemp8 = int(fRec0[0]);
			float fTemp9 = std::floor(fRec0[0]);
			fRec26[0] = 0.05f * fTemp4 - fSlow8 * (fSlow7 * fRec26[2] - fSlow5 * fRec26[1]);
			float fTemp10 = fSlow8 * (fSlow12 * (fSlow11 * fRec26[1] + fSlow10 * fRec26[0] + fSlow10 * fRec26[2]) + fSlow9 * (fRec26[1] + 0.5f * fRec26[0] + 0.5f * fRec26[2])) + fSlow2 * ((fVec2[(IOTA0 - std::min<int>(1025, std::max<int>(0, iTemp8))) & 2047] * (fTemp9 + (1.0f - fRec0[0])) + (fRec0[0] - fTemp9) * fVec2[(IOTA0 - std::min<int>(1025, std::max<int>(0, iTemp8 + 1))) & 2047]) * fTemp0 + (fVec2[(IOTA0 - std::min<int>(1025, std::max<int>(0, iTemp6))) & 2047] * (fTemp7 + (-999.0f - fRec0[0])) + (fRec0[0] + (1e+03f - fTemp7)) * fVec2[(IOTA0 - std::min<int>(1025, std::max<int>(0, iTemp6 + 1))) & 2047]) * (1.0f - fTemp0));
	...
	FAUST_ADDHORIZONTALSLIDER("FreqHigh", fHslider2, 1e+03f, 1e+02f, 1e+04f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("QHigh", fHslider3, 1.0f, 0.01f, 1e+02f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("mode", fHslider1, 0.0f, 0.0f, 2.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("shift", fHslider0, 0.0f, -12.0f, 12.0f, 0.1f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, FreqHigh, "FreqHigh", fHslider2, 1e+03f, 1e+02f, 1e+04f, 1.0f) \
		p(HORIZONTALSLIDER, QHigh, "QHigh", fHslider3, 1.0f, 0.01f, 1e+02f, 0.01f) \
		p(HORIZONTALSLIDER, mode, "mode", fHslider1, 0.0f, 0.0f, 2.0f, 1.0f) \
		p(HORIZONTALSLIDER, shift, "shift", fHslider0, 0.0f, -12.0f, 12.0f, 0.1f) \
